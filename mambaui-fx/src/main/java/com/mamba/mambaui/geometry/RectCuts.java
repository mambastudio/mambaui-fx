package com.mamba.mambaui.geometry;


import static com.mamba.mambaui.geometry.RectCuts.RectCutSide.BOTTOM;
import static com.mamba.mambaui.geometry.RectCuts.RectCutSide.LEFT;
import static com.mamba.mambaui.geometry.RectCuts.RectCutSide.RIGHT;
import static com.mamba.mambaui.geometry.RectCuts.RectCutSide.TOP;
import static java.lang.Double.max;
import static java.lang.Double.min;
import java.util.Objects;

/**
 * Immutable rectangle slicing primitives inspired by Halt's RectCut article.
 * <p>
 * RectCut is not a JavaFX layout pane. It is a small geometry technique for
 * repeatedly cutting rectangles from a remaining area, then using those
 * rectangles inside custom layout, painting, or hit-testing code.
 */
public sealed interface RectCuts {
    ...
    public record Rect(double minx, double miny, double maxx, double maxy) implements RectCuts{
    ...
    public record RectCut(Rect rect, Rect remainingRect, RectCutSide side) implements RectCuts{
        public RectCut{
