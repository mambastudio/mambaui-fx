 ...
 */
package com.mamba.mambaui.samples.closebutton;


import com.mamba.mambaui.icon.IconButtons;
import com.mamba.mambaui.theme.MambauiTheme;
...
public class CloseButtonApplication  extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        Button closeBtn = IconButtons.fontIconButton("mdal-close", 30, "circular-button", "close-icon");
